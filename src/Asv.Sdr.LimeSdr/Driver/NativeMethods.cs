...
namespace Asv.Sdr.LimeSdr
{
    ...
    public unsafe struct LmsRangeT
    {
        public double min;
        public double max;
        public double step;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public unsafe struct LmsStreamTX32
    {
        public uint handle;
        public bool isTx;
        public uint channel;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public unsafe struct LmsStreamTX64
    {
    ...
    public struct LmsDevInfoT
    {
        public char[] deviceName;

        // <The display name of the device
        public char[] expansionName;
        ...
        public ulong boardSerialNumber;

        // <A unique board serial number
        public char[] gatewareVersion;

        // <Gateware version as a string
        public char[] gatewareTargetBoard;
    }

    public enum LmsLoopbackT
    {
        LMS_LOOPBACK_NONE,
        /*<Return to normal operation (disable loopback)*/
    }
    ...
    {
        private static readonly ILogger<NativeMethods> Logger =
            LmsLogManager.GetLogger<NativeMethods>();
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_RegisterLogHandler",
            CallingConvention = CallingConvention.Cdecl
        )]
        ...
        public static int LMS_SetLOFrequency(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double frequency
        ...
        public static int LMS_GetLOFrequency(
            IntPtr device,
            bool dir_tx,
            uint chan,
        ...
        public static unsafe int LMS_SetNCOFrequency(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double* frequency,
        ...
        public static unsafe int LMS_GetNCOFrequency(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double* frequency,
        ...
        public static int LMS_SetNCOIndex(
            IntPtr device,
            bool dir_tx,
            uint chan,
            int index,
        ...
        public static int LMS_SetNCOPhase(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double phase,
        ...
        public static int LMS_GetNCOPhase(
            IntPtr device,
            bool dir_tx,
            uint chan,
            ref double phase,
        ...
        public static int LMS_SetSampleRateDir(
            IntPtr device,
            bool dir_tx,
            double rate,
            uint oversample
        ...
        public static int LMS_GetSampleRate(
            IntPtr device,
            bool dir_tx,
            uint chan,
            ref double host_Hz,
        ...
        public static unsafe int LMS_RecvStream(
            IntPtr stream,
            void* samples,
            uint sample_count,
            ref LmsStreamMetaT meta,
            uint timeout_ms
        )
        {
            return Is64BitOperatingSystem
        ...
        public static unsafe int LMS_SendStream(
            IntPtr stream,
            void* samples,
            uint sample_count,
            ref LmsStreamMetaT meta,
        ...
        public static unsafe int LMS_SetTestSignal(
            IntPtr device,
            bool dir_tx,
            uint chan,
            LmsTestsigT sig,
        ...
        public static unsafe int LMS_GetNormalizedGain(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double* gain
        ...
        public static unsafe int LMS_SetLPFBW(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double bandwidth
        ...
        public static unsafe int LMS_GetLPFBW(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double* bandwidth
        ...
        public static unsafe int LMS_GetLPFBWRange(
            IntPtr device,
            bool dir_tx,
            uint chan,
            LmsRangeT* range
        ...
        public static unsafe int LMS_SetGFIRLPF(
            IntPtr device,
            bool dir_tx,
            uint chan,
            bool enable,
        ...
        public static unsafe int LMS_SetGFIRCoeff(
            IntPtr device,
            bool dir_tx,
            uint chan,
            IntPtr filt,
        ...
        public static unsafe int LMS_GetGFIRCoeff(
            IntPtr device,
            bool dir_tx,
            uint chan,
            IntPtr filt,
        ...
        public static unsafe int LMS_GetAntennaBW(
            IntPtr device,
            bool dir_tx,
            uint chan,
            uint path,
        ...
        public static unsafe int LMS_Calibrate(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double bw,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_EnableChannel",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_EnableChannel_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            bool enabled
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetLOFrequency",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetLOFrequency_X64(
            IntPtr device,
            bool dir_tx,
            uint chan,
            double frequency
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetLOFrequency",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_GetLOFrequency_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            ref double frequency
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetNCOFrequency",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetNCOFrequency_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double* frequency,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetNCOFrequency",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetNCOFrequency_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double* frequency,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetNCOIndex",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetNCOIndex_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            int index,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetNCOPhase",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetNCOPhase_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double phase,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetNCOPhase",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_GetNCOPhase_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            ref double phase,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetSampleRateDir",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetSampleRateDir_X64(
            IntPtr device,
            bool dir_tx,
            double rate,
            UInt64 oversample
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetSampleRate",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetSampleRate_X64(
            IntPtr device,
            double rate,
            UInt64 oversample
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetSampleRate",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_GetSampleRate_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            ref double host_Hz,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_RecvStream",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_RecvStream_X64(
            IntPtr stream,
            void* samples,
            UInt64 sample_count,
            ref LmsStreamMetaT meta,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SendStream",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SendStream_X64(
            IntPtr stream,
            void* samples,
            UInt64 sample_count,
            ref LmsStreamMetaT meta,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetAntenna",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetAntenna_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            UInt64 index
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetTestSignal",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetTestSignal_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            LmsTestsigT sig,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GPIOWrite",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GPIOWrite_X64(
            IntPtr device,
            void* buffer,
            UInt64 length
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GPIODirWrite",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GPIODirWrite_X64(
            IntPtr device,
            void* buffer,
            UInt64 length
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GPIORead",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GPIORead_X64(
            IntPtr device,
            void* buffer,
            UInt64 length
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GPIODirRead",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GPIODirRead_X64(
            IntPtr device,
            void* buffer,
            UInt64 length
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetGaindB",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetGaindB_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            UInt64 gain
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetGaindB",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetGaindB_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            UInt64* gain
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetNormalizedGain",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern int LMS_SetNormalizedGain_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double gain
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetNormalizedGain",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetNormalizedGain_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double* gain
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetChipTemperature",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetChipTemperature_X64(
            IntPtr dev,
            UInt64 ind,
            double* temp
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetLPFBW",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetLPFBW_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double bandwidth
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetLPFBW",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetLPFBW_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double* bandwidth
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetLPFBWRange",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetLPFBWRange_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            LmsRangeT* range
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetLPF",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetLPF_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            bool enable
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetGFIRLPF",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetGFIRLPF_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            bool enable,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetGFIRCoeff",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetGFIRCoeff_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            IntPtr filt,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetGFIRCoeff",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetGFIRCoeff_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            IntPtr filt,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetAntennaBW",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetAntennaBW_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            UInt64 path,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetClockFreq",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetClockFreq_X64(
            IntPtr device,
            UInt64 clk_id,
            double* freq
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_SetClockFreq",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_SetClockFreq_X64(
            IntPtr device,
            UInt64 clk_id,
            double freq
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_Calibrate",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_Calibrate_X64(
            IntPtr device,
            bool dir_tx,
            UInt64 chan,
            double bw,
        ...
        public static extern int LMS_SetLOFrequency_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double frequency
        ...
        public static extern int LMS_GetLOFrequency_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            ref double frequency
        ...
        public static extern unsafe int LMS_SetNCOFrequency_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double* frequency,
        ...
        public static extern int LMS_EnableChannel_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            bool enabled
        ...
        public static extern unsafe int LMS_GetNCOFrequency_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double* frequency,
        ...
        public static extern int LMS_SetNCOIndex_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            int index,
        ...
        public static extern int LMS_SetNCOPhase_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double phase,
        ...
        public static extern int LMS_GetNCOPhase_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            ref double phase,
        ...
        public static extern int LMS_SetSampleRateDir_X32(
            IntPtr device,
            bool dir_tx,
            double rate,
            UInt32 oversample
        ...
        public static extern int LMS_SetSampleRate_X32(
            IntPtr device,
            double rate,
            UInt32 oversample
        );
        ...
        public static extern int LMS_GetSampleRate_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            ref double host_Hz,
        ...
        public static extern unsafe int LMS_RecvStream_X32(
            IntPtr stream,
            void* samples,
            UInt32 sample_count,
            ref LmsStreamMetaT meta,
        ...
        public static extern unsafe int LMS_SendStream_X32(
            IntPtr stream,
            void* samples,
            uint sample_count,
            ref LmsStreamMetaT meta,
        ...
        public static extern unsafe int LMS_SetAntenna_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            UInt32 index
        ...
        public static extern unsafe int LMS_SetTestSignal_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            LmsTestsigT sig,
        ...
        public static extern unsafe int LMS_GPIOWrite_X32(
            IntPtr device,
            void* buffer,
            UInt32 length
        );
        ...
        public static extern unsafe int LMS_GPIODirWrite_X32(
            IntPtr device,
            void* buffer,
            UInt32 length
        );
        ...
        public static extern unsafe int LMS_GPIORead_X32(
            IntPtr device,
            void* buffer,
            UInt32 length
        );
        ...
        public static extern unsafe int LMS_GPIODirRead_X32(
            IntPtr device,
            void* buffer,
            UInt32 length
        );
        ...
        public static extern int LMS_SetGaindB_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            UInt32 gain
        ...
        public static extern unsafe int LMS_GetGaindB_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            UInt32* gain
        ...
        public static extern int LMS_SetNormalizedGain_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double gain
        ...
        public static extern unsafe int LMS_GetNormalizedGain_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double* gain
        ...
        public static extern unsafe int LMS_GetChipTemperature_X32(
            IntPtr dev,
            UInt32 ind,
            double* temp
        );
        ...
        public static extern unsafe int LMS_SetLPFBW_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double bandwidth
        ...
        public static extern unsafe int LMS_GetLPFBW_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double* bandwidth
        ...
        public static extern unsafe int LMS_GetLPFBWRange_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            LmsRangeT* range
        ...
        public static extern unsafe int LMS_SetLPF_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            bool enable
        ...
        public static extern unsafe int LMS_SetGFIRLPF_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            bool enable,
        ...
        public static extern unsafe int LMS_SetGFIRCoeff_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            IntPtr filt,
        ...
        public static extern unsafe int LMS_GetGFIRCoeff_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            IntPtr filt,
        ...
        public static extern unsafe int LMS_GetAntennaBW_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            UInt32 path,
        ...
        public static extern unsafe int LMS_GetClockFreq_X32(
            IntPtr device,
            UInt32 clk_id,
            double* freq
        );
        ...
        public static extern unsafe int LMS_SetClockFreq_X32(
            IntPtr device,
            UInt32 clk_id,
            double freq
        );
        ...
        public static extern unsafe int LMS_Calibrate_X32(
            IntPtr device,
            bool dir_tx,
            UInt32 chan,
            double bw,
        ...
        public static int LMS_SetupStream(
            IntPtr device,
            bool dir_tx,
            DataFormat dataFmt,
            ref IntPtr stream,
        ...
        )
        {
            if (Is64BitOperatingSystem)
            {
                var streamId = new LmsStreamTX64
                {
                    handle = 0,
                    channel = chan,
                    fifoSize = fifoSize,
            ...
            {
                var streamId = new LmsStreamTX32
                {
                    handle = 0,
                    channel = chan,
                    fifoSize = fifoSize,
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetLastErrorMessage",
            CallingConvention = CallingConvention.Cdecl
        )]
        ...
        public static string limesdr_strerror()
        {
            ...
            if (ret != IntPtr.Zero)
            {
                return Marshal.PtrToStringAnsi(ret) ?? string.Empty;
            }
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_ReadParam",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_ReadParam(
            IntPtr device,
            LMS7Parameter param,
            ushort* val
        );
        ...
        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetStreamStatus",
            CallingConvention = CallingConvention.Cdecl
        )]
        public static extern unsafe int LMS_GetStreamStatus(
            IntPtr stream,
            ref LmsStreamStatus status
        );

        [DllImport(
            "LimeSuite",
            EntryPoint = "LMS_GetLibraryVersion",
            CallingConvention = CallingConvention.Cdecl
        )]
