...
namespace Asv.Sdr.LimeSdr
{
    ...
    public interface ILmsStream : IDisposable
    {
        ...
        LmsStreamMetaT Metadata { get; }
        void EditMetadata(Func<LmsStreamMetaT, LmsStreamMetaT> edit);
        Task<int> Read(
    ...
    public interface ILimeSdrDevice : IDisposable
    {
        ...
        Task<ILmsStream> CreateStream(
            LmsChannel type,
            uint channel,
            uint bufferLength,
            float throughputVsLatency = 0.5F,
    ...
    public static class LimeSdrDeviceHelper
    {
        ...
        /// <returns>.</returns>
        public static async Task EnableRSSIMeasure(
            this ILimeSdrDevice src,
            byte samples = 1,
            CancellationToken cancel = default
        )
        {
        ...
        public static async Task WriteFpgaRegisterBits(
            this ILimeSdrDevice src,
            ushort address,
            ushort index,
            ushort length,
        ...
        public static async Task<ushort> ReadFpgaRegisterBits(
            this ILimeSdrDevice src,
            ushort address,
            ushort index,
            ushort length,
