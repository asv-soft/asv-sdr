...
namespace Asv.Sdr.Msi
{
    public sealed class MsiDevice : IDisposable
    {
        ...
        private mir_sdr_If_kHzT IFTypeDecimation;     
        ...
        private mir_sdr_Bw_MHzT SDRplayIFBandwidth;
        private mir_sdr_If_kHzT SDRplayIFType;
        ...
        public unsafe void SDRplay_Initalisation()
        {
            int DownSampleFactor;
                ...
                if (res == mir_sdr_ErrT.mir_sdr_Success)
                {
                    ...
                    if (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_Zero)
                    {
                    ...
                    {
                        if ((((SampleRateIndex == 15) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_1_536) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_2_048)) ||
                            ((SampleRateIndex == 8) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_200) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_0_450)) ||
                            ((SampleRateIndex == 8) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_300) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_0_450))) && DownconversionEnabledTS)
                        {
                            Decimation = 4;
                        ...
                        if (((SampleRateIndex == 8) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_600) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_0_450)) && DownconversionEnabledTS)
                        {
                            Decimation = 2;
                            IFTypeDecimation = IFFrequency;
        ...
        private static mir_sdr_ErrT SetLo(double nominalFrequency)
        {
            mir_sdr_ErrT err = mir_sdr_ErrT.mir_sdr_Success;
        ...
        public double SampleRate
        {
            get
            {
                ...
                if (DownSampleTable[SampleRateIndex] == 0)
                {
                    ...
                    if ((((SampleRateIndex == 15) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_1_536) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_2_048)) ||
                        ((SampleRateIndex == 8) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_200) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_0_450)) ||
                        ((SampleRateIndex == 8) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_300) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_0_450))) && DownconversionEnabled)
                    {
                        SR = SR / 4;
                        Trace.WriteLine("SampleRate Rate /4 called");
                    }
                    if (((SampleRateIndex == 8) && (Bandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_600) && (IFFrequency == mir_sdr_If_kHzT.mir_sdr_IF_0_450)) && DownconversionEnabled)
                    {
                        SR = SR / 2;
        ...
        public mir_sdr_Bw_MHzT Bandwidth
        {
            ...
            set
            {
                ...
                if (IFType == 0)
                {
                    IFFrequency = mir_sdr_If_kHzT.mir_sdr_IF_Zero;
                }
                else
                {
                    if (SDRplayIFBandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_200 ||
                        SDRplayIFBandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_300 ||
                        SDRplayIFBandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_0_600)
                    {
                        IFFrequency = mir_sdr_If_kHzT.mir_sdr_IF_0_450;
                    }
                    if (SDRplayIFBandwidth == mir_sdr_Bw_MHzT.mir_sdr_BW_1_536)
                        IFFrequency = mir_sdr_If_kHzT.mir_sdr_IF_2_048;
                }
            }
        }

        private mir_sdr_If_kHzT IFFrequency
        {
            get
            {
        ...
        unsafe private void ReaderThread(int DownSampleFactor, bool DownconversionEnabledTS)
        {
            ...
            while (Running)
            {
                ...
                int rfChanged;
                int fsChanged;
                mir_sdr_ErrT res = mir_sdr_ErrT.mir_sdr_Success;
