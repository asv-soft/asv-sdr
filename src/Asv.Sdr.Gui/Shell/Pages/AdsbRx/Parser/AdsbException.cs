...
{
    public AdsbParserException(string message)
        : base(message) { }

    public AdsbParserException(string message, Exception inner)
        : base(message, inner) { }
}
...
{
    public AdsbCrcErrorException()
        : base("Crc error occurred when recv message") { }
}
...
public class AdsbReadNotAllDataWhenDeserializePacketErrorException : AdsbParserException
{
    ...
    public AdsbReadNotAllDataWhenDeserializePacketErrorException(string messageId)
        : base($"Read not all data when deserialize '{messageId}' message")
    {
        MessageId = messageId;
    }
}
...
public class AdsbUnknownMessageException : AdsbParserException
{
    ...
    public AdsbUnknownMessageException(string messageId)
        : base($"Unknown packet message number [MSG={messageId}]")
    {
        MessageId = messageId;
    }
}
...
public class AdsbDeserializeMessageException : AdsbParserException
{
    ...
    public AdsbDeserializeMessageException(string messageId, Exception inner)
        : base($"Deserialization [ID={messageId}] packet error ", inner)
    {
        MessageId = messageId;
    }
}
...
public class AdsbPublishMessageException : AdsbParserException
{
    ...
    public AdsbPublishMessageException(string messageId, Exception inner)
        : base($"Publication [ID={messageId}] packet throw exception ", inner)
    {
        MessageId = messageId;
    }
}
