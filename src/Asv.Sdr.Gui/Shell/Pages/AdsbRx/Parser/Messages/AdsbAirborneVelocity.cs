...
public abstract class AdsbAirborneVelocityBase : AdsbExtendedSquitterBase
{
    ...
    protected override void InternalDeserialize(ref ReadOnlySpan<byte> buffer)
    {
        ...
        NavigationUncertaintyCategory = (NavigationUncertaintyCategoryEnum)
        ...
        GnssBaroAltDiff =
            sDiff * GetGnssBaroAltDiff(SpanBitHelper.GetBitU(buffer, ref bitIndex, 7));
    ...
    protected override void InternalSerialize(ref Span<byte> buffer)
    {
        ...
        SpanBitHelper.SetBitU(
            ...
            ref bitIndex,
            1,
            VrSrc == VerticalRateSourceEnum.Gnss ? 0 : 1
        );
    ...
    protected abstract void ReadVelocityData(
        ReadOnlySpan<byte> buffer,
        ref int pos,
        VelocitySubTypeEnum subType
    );
    protected abstract void WriteVelocityData(
        Span<byte> buffer,
        ref int pos,
        VelocitySubTypeEnum subType
    );
...
public class AdsbGroundSpeed : AdsbAirborneVelocityBase
{
    ...
    protected override void ReadVelocityData(
        ReadOnlySpan<byte> buffer,
        ref int pos,
        VelocitySubTypeEnum subType
    )
    ...
    protected override void WriteVelocityData(
        Span<byte> buffer,
        ref int pos,
        VelocitySubTypeEnum subType
    )
...
public class AdsbAirspeed : AdsbAirborneVelocityBase
{
    ...
    )
    {
        ...
        AirspeedType =
            SpanBitHelper.GetBitU(buffer, ref pos, 1) == 0
                ? AirspeedTypeEnum.IAS
                : AirspeedTypeEnum.TAS;
