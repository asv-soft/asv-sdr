...
namespace Asv.Sdr
{
    public class ReaderIqFilterIDouble : ReaderIqSubject<double, double>
    {
        ...
        public ReaderIqFilterIDouble(IReaderIqSubject<double> input, IDspFilter iFilter,  bool useArrayPool = true) : base(input, input.OutputBufferSize, useArrayPool)
        {
            _iFilter = iFilter;
        }
    ...
    public class ReaderIqFilterIFloat : ReaderIqSubject<float, double>
    {
        ...
        public ReaderIqFilterIFloat(IReaderIqSubject<float> input, IDspFilter iFilter, bool useArrayPool = true) : base(input, input.OutputBufferSize, useArrayPool)
        {
            _iFilter = iFilter;
        }
