...
namespace Asv.Sdr.V2
{
    ...
    public class ReaderIqFilterIqDouble : ReaderIqSubject<double, double>
    {
        ...
        public ReaderIqFilterIqDouble(IReaderIqSubject<double> input, IDspFilter iFilter, IDspFilter qFilter, bool useArrayPool = true) : base(input, input.OutputBufferSize, useArrayPool)
        {
            _iFilter = iFilter;
            _qFilter = qFilter;
        }
    ...
    public class ReaderIqFilterIqFloat : ReaderIqSubject<float, double>
    {
        ...
        public ReaderIqFilterIqFloat(IReaderIqSubject<float> input, IDspFilter iFilter, IDspFilter qFilter, bool useArrayPool = true) : base(input, input.OutputBufferSize, useArrayPool)
        {
            _iFilter = iFilter;
            _qFilter = qFilter;
        }
