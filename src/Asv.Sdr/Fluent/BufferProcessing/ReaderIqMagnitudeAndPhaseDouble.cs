...
namespace Asv.Sdr
{
    ...
    {
        public ReaderIqMagnitudeAndPhaseDouble(IReaderIqSubject<double> src, bool useArrayPool) : base(src, src.OutputBufferSize, useArrayPool)
        {
    ...
    {
        public ReaderIqMagnitudeAndPhaseFloat(IReaderIqSubject<float> src, bool useArrayPool) : base(src, src.OutputBufferSize, useArrayPool)
        {
